...
export enum FeedUrl {
  PRODUCTION = 'https://github.com/zetaloop/cherry-studio/releases/latest/download',
  GITHUB_LATEST = 'https://github.com/zetaloop/cherry-studio/releases/latest/download'
}
...
export const defaultTimeout = 30 * 1000 * 60
